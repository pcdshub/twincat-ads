...
private:
  ...
  asynStatus adsGenericArrayWrite(uint16_t amsClientPort, asynUser *pasynUser,
                                  long allowedType,
                                  const void *epicsDataBuffer,
                                  size_t nEpicsBufferBytes);
  asynStatus adsGenericArrayRead(uint16_t amsClientPort, asynUser *pasynUser,
                                 long allowedType,
  ...
  int        octetCMDreadIt(uint16_t amsClientPort, char *outbuf,
                            size_t outlen);
  int        octetCMDwriteIt(uint16_t amsClientPort, const char *inbuf,
                             size_t inlen);
  int        octetCmdHandleInputLine(uint16_t amsClientPort, const char *input_line,
                                     adsOctetOutputBufferType *buffer);
  int        octetMotorHandleOneArg(uint16_t amsClientPort, const char *myarg_1,
                                    adsOctetOutputBufferType *buffer);
  int        octetMotorHandleADRCmd(uint16_t amsClientPort, const char *arg,
                                    uint16_t adsport,
                                    adsOctetOutputBufferType *buffer);
